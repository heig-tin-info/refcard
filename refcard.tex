...
\begin{tabularx}{\linewidth}{Xl}
  ...
  Commentaire C99                    & \cd{// commentaire jusqu'à la fin de ligne} \\
  Commentaire traditionnel           & \cd{/* commentaire multi-ligne */} \\
\end{tabularx}
...
\begin{tabularx}{\linewidth}{X|l|l|l}
  ...
  \hline
  Caractère                   & \cd{char}      & (peut être signé ou non) & 8 bits \\
  \hline
